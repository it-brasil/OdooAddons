{
    ...
    'summary': """
        This module allows you to send whatsapp messages about the sale orders orders, 
        invoice order amount.""",

    'description': """
    """,
    'author': "IT Brasil, Techspawn Solutions Pvt. Ltd.",
    ...
    'depends': ['base', 'sale', 'web','account','contacts'],
