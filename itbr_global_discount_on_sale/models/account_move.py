...
class AccountInvoice(models.Model):
    ...
    # @api.depends('invoice_line_ids.price_subtotal', 'tax_line_id.price_unit',
    #              'tax_line_id.amount_rounding',
    ...
    def _compute_amount(self):
        ...
        self.amount_tax = sum(
            round_curr(line.amount_total) for line in self.line_ids.tax_line_id)
